...
const USB_Descriptor_Device_t PROGMEM DeviceDescriptor =
{
	...
	.VendorID               = 0x16D0,
	.ProductID              = 0x0668,
	.ReleaseNumber          = VERSION_BCD(00.24),
...
{
	.Header                 = {.Size = USB_STRING_LEN(20), .Type = DTYPE_String}, // may need to hard set the size below
																				 // see DTYPE_String and case 0x02

	.UnicodeString          = L"VMeter EEPROM Writer"
};
